...
export const volunteers: VolunteerCandidate[] = [
  {
    ...
    availableWindows: [{ start: "2025-03-04T02:00:00Z", end: "2025-03-04T04:00:00Z" }], // Tue 10:00-12:00 SGT
  ...
  },
  {
    ...
    languages: ["english"],
    availableWindows: [{ start: "2025-03-05T01:00:00Z", end: "2025-03-05T03:00:00Z" }],
  ...
  },
  {
    ...
    industryTags: ["technology"],
    languages: ["english", "mandarin"],
    availableWindows: [{ start: "2025-03-06T05:00:00Z", end: "2025-03-06T06:00:00Z" }],
  ...
  },
  {
    ...
    availableWindows: [{ start: "2025-03-07T00:00:00Z", end: "2025-03-07T01:00:00Z" }],
  ...
  },
  {
    ...
    industryTags: ["legal"],
    languages: ["english"],
    availableWindows: [{ start: "2025-03-04T02:00:00Z", end: "2025-03-04T02:30:00Z" }],
    supportedModes: ["async"],
    supportedAccessPreferences: [],
    livedExperienceTags: [],
  ...
  },
  {
    ...
    availableWindows: [{ start: "2025-03-10T09:00:00Z", end: "2025-03-10T10:00:00Z" }],
    supportedModes: ["live_online"],
    supportedAccessPreferences: ["step_by_step_explanation", "support_person_welcome"],
  ...
  },
  {
    ...
    expertiseTags: ["cybersecurity", "cloud infrastructure", "product management"],
    industryTags: ["technology"],
    languages: ["english", "hindi"],
    availableWindows: [{ start: "2025-03-04T01:00:00Z", end: "2025-03-04T05:00:00Z" }],
    supportedModes: ["async", "live_online", "either"],
    supportedAccessPreferences: ["written_instructions", "simple_language", "captioning"],
  ...
  },
  {
    ...
    availableWindows: [{ start: "2025-03-09T23:00:00Z", end: "2025-03-10T00:00:00Z" }],
  ...
  },
  {
    ...
    languages: ["english", "mandarin"],
    availableWindows: [{ start: "2025-03-11T00:00:00Z", end: "2025-03-11T01:00:00Z" }], // no overlap with the sample teach_me_something request
