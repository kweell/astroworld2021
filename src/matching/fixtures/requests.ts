...
export const teachMeSomethingRequest: MatchRequest = {
  ...
  durationMinutes: 30,
  availabilityWindows: [{ start: "2025-03-04T02:00:00Z", end: "2025-03-04T04:00:00Z" }],
...
export const sampleRequests = [askMeAnythingRequest, teachMeSomethingRequest, reviewMyWorkRequest];
